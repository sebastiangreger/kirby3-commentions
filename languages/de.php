...
$translations = [
    ...
    'section.error.cronjob-alert'        => '<strong>Konfiguration unvollständig:</strong> Der zur Verarbeitung eingehender Webmentions nötige Cronjob wurde in den letzten 24 Stunden nicht ausgeführt. Um diese Fehlermeldung auszublenden, kannst du <a href="https://github.com/sebastiangreger/kirby3-commentions/blob/master/README.md#step-3-setting-up-webmentions-optional" rel="noopener noreferrer" target="_blank">den Cronjob einrichten</a> oder <a href="https://github.com/sebastiangreger/kirby3-commentions/blob/master/README.md#limit-by-template" rel="noopener noreferrer" target="_blank">Webmentions deaktivieren</a>.',
];
