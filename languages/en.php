...
$translations = [
    ...
    'section.error.cronjob-alert'        => '<strong>Setup issue:</strong> The cron job required to process incoming webmentions, has not been run in the last 24h. To get rid of this warning, you may <a href="https://github.com/sebastiangreger/kirby3-commentions/blob/master/README.md#step-3-setting-up-webmentions-optional" rel="noopener noreferrer" target="_blank">set up the cronjob</a> or <a href="https://github.com/sebastiangreger/kirby3-commentions/blob/master/README.md#limit-by-template" rel="noopener noreferrer" target="_blank">disable webmentions</a>.',
];
