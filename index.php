...
if (F::exists(__DIR__ . '/vendor/autoload.php') === false) {
    ...
    load([
        ...
        'sgkirby\\commentions\\Sanitizer' => 'classes/Sanitizer.php',
        'sgkirby\\commentions\\Sanitizer\\CacheAdapter' => 'classes/Sanitizer/CacheAdapter.php',
        'sgkirby\\commentions\\Sanitizer\\CodeClassAttrDef' => 'classes/Sanitizer/CodeClassAttrDef.php',
        'sgkirby\\commentions\\Sanitizer\\LinkTransformer' => 'classes/Sanitizer/LinkTransformer.php',
        'sgkirby\\commentions\\Sanitizer\\RemoveEmptyLinksInjector' => 'classes/Sanitizer/RemoveEmptyLinksInjector.php',
